    ...
    public void refreshcycle(){
    	...
    	case 0:
    		...
    		if(prefs.getBoolean("twitter_rensselaer", true)){
	    		...
	    		tst.show();
	    		//download the feed
    			downloadtask = new TwitterFragment.Download().execute("rensselaer");
    		}
    		else{
    	...
    	case 1:
    		...
    		if(prefs.getBoolean("twitter_rpinews", true)){
	    		...
	    		tst.show();
	    		downloadtask = new TwitterFragment.Download().execute("RPInews");
	    	}
    		else{
    			refreshcycle();
    		}
    	...
    	case 2:
    		...
    		if(prefs.getBoolean("twitter_RPIAlumni", true)){
	    		...
	    		tst.show();
	    		downloadtask = new TwitterFragment.Download().execute("RPIAlumni");
	    	}
    		else{
    			refreshcycle();
    		}
    	...
    	case 3:
    		...
    		if(prefs.getBoolean("twitter_RPILally", true)){
	    		...
	    		tst.show();
	    		downloadtask = new TwitterFragment.Download().execute("RPILally");
    		}
    		else{
    			refreshcycle();
    		}
    	...
    	case 4:
    		...
    		if(prefs.getBoolean("twitter_EMPACNews", true)){
	    		...
	    		tst.show();
	    		downloadtask = new TwitterFragment.Download().execute("EMPACnews");
    		}
    		else{
    			refreshcycle();
    		}
    	...
    	case 5:
    		...
    		if(prefs.getBoolean("twitter_RPISciDean", true)){
    			...
    			tst.show();
    			downloadtask = new TwitterFragment.Download().execute("RPISciDean");
    		}
    		else{
    			refreshcycle();
    		}
    	...
    	case 6:
    		...
    		if(prefs.getBoolean("twitter_RPI_CCPD", true)){
	    		...
	    		tst.show();
	    		downloadtask = new TwitterFragment.Download().execute("RPI_CCPD");
    		}
    		else{
    			refreshcycle();
    		}
    	...
    	case 7:
    		...
    		if(!prefs.getString("customtwitter", "").equals("")){
	    		...
	    		tst.show();
	    		downloadtask = new TwitterFragment.Download().execute(prefs.getString("customtwitter", ""));
    		}
    		else{
    			refreshcycle();
    		}
